...
# Submit B: climb from 67.5 (~750 N) toward ~81. Do not edit attack.py (750 backup).
PRACTICAL_N_CAP: Final[int] = 900
...
REPLAY_SAFE_FRAC: Final[float] = 0.95  # slightly safer vs timeout zeros
